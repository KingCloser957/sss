...
class MKGlowingMarker {
    ...
    init(lat: Float, lon: Float, altitude:Float, markerZindex: Int, style: Style,icon:String? = nil) {
        latitude = lat
        longitude = lon
        ...
        case .dot:
            ...
            geometry.firstMaterial!.diffuse.contents = icon ?? "yellowGlow-32x32.png"
            // appear a little washed out in daylight... 
            geometry.firstMaterial!.diffuse.intensity = 0.2
            geometry.firstMaterial!.emission.contents = icon ?? "yellowGlow-32x32.png"
